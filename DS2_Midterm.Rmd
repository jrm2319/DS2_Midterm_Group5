...
(2) Evaluate the robustness and generalizability of your prediction model using the new dataset. 
(3) Does the model generalize well to this new dataset? If the model does not generalize well, discuss possible reasons.
