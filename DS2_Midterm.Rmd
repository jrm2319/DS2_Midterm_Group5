...
$$
\text{log}_{\\antibody} = \beta_0 + s_1(\text{age}) + \beta_1 \cdot \text{gender} + \beta_2 \cdot \text{race} + \beta_3 \cdot \text{smoking} + \beta_4 \cdot \text{height} + \beta_5 \cdot \text{weight} + s_2(\text{bmi}) + \beta_6 \cdot \text{diabetes} + \beta_7 \cdot \text{hypertension} + s_3(\text{SBP}) + s_4(\text{LDL}) + s_5(\text{time}) + \varepsilon
$$
